-- Script d'installation SQL consolidé pour module Booking v2.1
-- Toutes les tables avec leur structure complète et cohérente

-- ============================================
-- Table principale : Éléments réservables
-- ============================================
...
-- ============================================
-- Table : Liaison produits PrestaShop
-- ============================================
...
-- ============================================
-- Table : Liaison réservations-commandes
-- ============================================
...
-- ============================================
-- Table : Sessions Stripe (pour paiements)
-- ============================================
CREATE TABLE IF NOT EXISTS `PREFIX_booking_stripe_sessions` (
...
-- ============================================
-- Table : Traductions des éléments
-- ============================================
